...
import { AppBar, Box, Button, Card, CardActionArea, CardContent, Container, Grid, IconButton, List, ListItem, Toolbar, Typography } from "@mui/material";
    ...
    if (docSnap.exists()) {
      ...
      collections = collections.map(flashcard => {
        if (flashcard.name === name) {
          return { ...flashcard, favorite: !flashcard.favorite, favoritedAt: flashcard.favorite ? null : new Date().getTime() };
        }
        return flashcard;
      });
          ...
          <Grid item xs={12} sm={4}>
            ...
            <List sx={{ padding: 0, margin: 0 }}>
              <ListItem sx={{ padding: 0 }}>
                <Button color="inherit" href="/generate">Generate Flashcards</Button>
              </ListItem>
              <ListItem sx={{ padding: 0 }}>
                <Button color="inherit" href="/flashcards">My Flashcards</Button>
              </ListItem>
